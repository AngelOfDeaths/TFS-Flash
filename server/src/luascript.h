...
class LuaScriptInterface
{
	...
	protected:
		...
		// Cast system
		static int32_t luaPlayerGetCast(lua_State* L);
		static int32_t luaPlayerGetCastViewers(lua_State* L);
		static int32_t luaPlayerSetCastPassword(lua_State* L);
		static int32_t luaPlayerSetCastState(lua_State* L);
		static int32_t luaPlayerSetCastDescription(lua_State* L);
		static int32_t luaPlayerIsCasting(lua_State* L);
