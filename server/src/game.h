...
class Game
{
	public:
		...
		void playerRuleViolationReport(uint32_t playerId, uint8_t reportType, uint8_t reason, const std::string& playerName, const std::string& comment, const std::string& translation, uint32_t statementId);
