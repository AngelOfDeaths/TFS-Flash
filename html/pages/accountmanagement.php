...
else
{
	if($action == "")
	{
		...
		foreach($account_players as $account_player)
		{
			...
			$main_content .= ';" ><td><a href="?subtopic=play&name=' . htmlspecialchars($account_player->getName()) . '"><img src="images/play.gif"></img></a><td>' . htmlspecialchars($account_player->getName()) . '</td>';
